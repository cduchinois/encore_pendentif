...
- **[`demo_script.md`](demo_script.md)** — the 5-minute, 7-beat script: decor → passive recognition → **the Shazam duel** (the key moment: a judge Shazams a rare bootleg live and fails; Encore displays, offline) → airplane mode → pin + privacy → the unreleased beat (Gemma ID card, then live SerpAPI resolve) → recap + Apple Music playlist in front of the jury. Rehearse ×2 minimum.
