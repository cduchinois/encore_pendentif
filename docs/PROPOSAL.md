...
- **Pendant**: Seeed XIAO ESP32-S3 Sense (built-in PDM mic), 3D rounded-heart case in two snap-fit shells (STL files ready: `encore_front.stl` + `encore_back.stl`, ≈55.5 × 58 × 18.4 mm, raised pulse-wave relief on the front, integrated Ø5.5 hanging hole, mic holes, USB-C slot to charge without opening).
