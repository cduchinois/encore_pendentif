...
.lp-nav{{display:flex;align-items:center;justify-content:space-between;padding:26px 24px}}
...
.hero{{display:flex;align-items:center;gap:40px;padding:40px 24px 30px}}
...
.steps{{display:flex;gap:24px;padding:60px 24px}}
...
.preorder{{margin:50px auto 70px;width:min(1140px,calc(100% - 48px));
  text-align:center;background:rgba(155,225,93,0.07);
...
.lp-footer{{border-top:1px solid rgba(255,255,255,0.1);padding:34px 24px 44px;
