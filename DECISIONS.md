...
- 2026-07-24 Chain-to-pendant clip: third-party two-half snap-link adopted, scaled x0.78 so its wire (6x10 -> 4.7x7.8, diag 9.1) threads the O9.8 bail and the cuban link opening; scaled copy auto-exported next to the gitignored original, embedded in the local viewer between bail and bottom link.
