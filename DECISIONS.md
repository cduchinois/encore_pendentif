...
- 2026-07-22 Fingerprint before Gemma in the ladder: a 2B model cannot memorize exact track identity; Gemma is the permanent brain (transitions, moments, recap, fiche ID), not the lookup.
